...
export default function Projects() {
  ...
  return (
    ...
    >
      {/* Animated Liquid Background - (Static Background) */}
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.tags.map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-3 py-1 bg-white/60 backdrop-blur-xl border border-white/80 rounded-full text-xs font-semibold text-gray-700 shadow-[0_2px_8px_rgba(0,0,0,0.05),inset_0_1px_0_rgba(255,255,255,0.9)]"
                        >
                          {tag}
                        </span>
                      ))}
