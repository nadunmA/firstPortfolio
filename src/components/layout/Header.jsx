  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 pt-6">
        <div className="max-w-5xl mx-auto relative">
          ...
          <div
            className={`relative max-w-5xl mx-auto transition-all duration-500 ease-out ${
              isScrolled
                ? "bg-white/10 backdrop-blur-3xl shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.3)]"
                : "bg-white/[0.07] backdrop-blur-2xl shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 max-w-5xl mx-auto">
